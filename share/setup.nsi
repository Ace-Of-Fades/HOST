...
Section -post SEC0001
    ...
    CreateDirectory $SMPROB\$StartMenuGroup
    CreateShortcut "$SMPROB\$StartMenuGroup\Uninstall NovaCoin.lnk" $INSTDIR\uninstall.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROB\$StartMenuGroup\Uninstall NovaCoin.lnk"
    #Delete /REBOOTOK "$SMPROB\$StartMenuGroup\Bitcoin.lnk"
    ...
    RmDir /REBOOTOK $SMPROB\$StartMenuGroup

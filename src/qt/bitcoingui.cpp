    ...
    blockBrowser(0)
{
    updateStyle();
    resize(850, 550);
    setWindowTitle(tr("HOST") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses2"), tr("&Addys"), this);
    receiveCoinsAction->setToolTip(tr("Shows all of your wallet's addresses"));
    ...
    addressBookAction->setToolTip(tr("View and edit stored contacts"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About HOST"), this);
    aboutAction->setToolTip(tr("Show information about HOST"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for HOST"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("HOST Wallet") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("HOST Wallet"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HOST network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(count < nTotalBlocks)
    {
        ...
        tooltip = tr("Downloaded %1 of %2 blocks of transfer history (%3% done).").arg(count).arg(nTotalBlocks).arg(nPercentageDone, 0, 'f', 2);
    }
    else
    {
        if (strStatusBarWarnings.isEmpty())
        ...
        progressBar->setVisible(false);
        tooltip = tr("Downloaded %1 blocks of transfer history.").arg(count);
    }
...
{
    QString strMessage =
        tr("Your space requires protection to reach it's destination. To continue you must purchase protection. "
          "Do you wish to purchase protection?").arg(
                BitcoinUnits::formatWithUnit(BitcoinUnits::BTC, nFeeRequired));
    QMessageBox::StandardButton retval = QMessageBox::question(
          this, tr("Confirm secure transfer"), strMessage,
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid HOST address or malformed URI parameters."));
    }
...
void BitcoinGUI::updateStyle()
{
    ...
    QString qssPath = QString::fromStdString( GetDataDir().string() ) + "/HOST.qss";

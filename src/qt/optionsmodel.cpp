...
void OptionsModel::Init()
{
    ...
    fUseHOSTTheme = settings.value("fUseHOSTTheme", true).toBool();
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
            ...
            break;
        case UseHOSTTheme:
            fUseHOSTTheme = value.toBool();
            settings.setValue("fUseHOSTTheme", fUseHOSTTheme);
            break;
        default:
            break;
        }
